= Error Messages
:description: The standardized error codes returned by the Couchbase Ruby SDK, from cloud connection to sub-document.
:page-topic-type: ref
...
* Further reference material in the https://docs.couchbase.com/sdk-api/couchbase-ruby-client/Couchbase.html[API Guide].
