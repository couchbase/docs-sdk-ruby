...
* *Map* is like Ruby `map` and is a key-value structure, where a value is accessed by using a key string.
* *List* is like a Ruby `array` and is a sequential data structure.
