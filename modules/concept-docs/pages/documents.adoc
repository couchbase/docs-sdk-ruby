...
[source,ruby]
----
include::devguide:example$ruby/documents.rb[tag=mutate-in]
----
...
[source,ruby]
----
include::devguide:example$ruby/documents.rb[tag=lookup-in]
----
...
[source,ruby]
----
include::devguide:example$ruby/documents.rb[tag=lookup-in-projections]
----
...
[source,ruby]
----
include::devguide:example$ruby/documents.rb[tag=counters]
----
...
[source,ruby]
----
include::devguide:example$ruby/documents.rb[tag=counters-increment]
----
