...
See the https://github.com/couchbase/couchbase-ruby-client/blob/8a042f28e8cc00423edd880164e1db132c687a96/lib/couchbase/management/bucket_manager.rb#L203-L254[commented guide in the repo^] for a full list of settings options.
