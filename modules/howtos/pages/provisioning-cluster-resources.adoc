...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-buckets.rb[tag=create]
----
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-buckets.rb[tag=get]
----
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=create-collection-manager,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=create-scope,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=create-collection,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=drop-collection,indent=0]

include::devguide:example$ruby/provisioning-resources-collections.rb[tag=drop-scope,indent=0]
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=scopeAdmin, indent=0]
...
[source,ruby]
----
include::devguide:example$ruby/provisioning-resources-collections.rb[tag=listing-scope-collection, indent=0]
----
