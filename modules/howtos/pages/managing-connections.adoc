...
[source,ruby]
----
include::devguide:example$ruby/managing_connections.rb[tag=multinodeconnect,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/managing_connections.rb[tag=explicitports,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/managing_connections.rb[tag=tls,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/managing_connections.rb[tag=dnssrv,indent=0]
----
