...
This can also be set and retrieved xref:7.0@server:rest-api:rest-set-up-alternate-address.adoc#assign-alternate-address-and-port-numbers[through the REST API].
