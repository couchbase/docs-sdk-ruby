...
// 
// It can be seen built at https://docs.couchbase.com/ruby-sdk/3.7/howtos/vector-searching-with-sdk.html
...
[source,ruby]
----
include::devguide:example$ruby/search.rb[tag=single-vector-query, indent=0]
----
...
See the link:++https://docs.couchbase.com/sdk-api/couchbase-ruby-client/Couchbase/VectorQuery.html#prefilter-instance_method++[API reference].
...
[source,ruby]
----
include::devguide:example$ruby/search.rb[tag=multiple-vector-queries, indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/search.rb[tag=vector-fts-query-combination, indent=0]
----
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client/Couchbase/VectorQuery.html[Ruby SDK API Reference].
...
* Vector Search in the https://docs.couchbase.com/sdk-api/couchbase-ruby-client/Couchbase/VectorSearch.html[Ruby SDK API reference].
