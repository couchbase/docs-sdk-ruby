...
// include::devguide:example$ruby/auth.rb[tag=auth1,indent=0]

[source,ruby]
----
include::devguide:example$ruby/auth.rb[tag=auth2,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/auth.rb[tag=auth3,indent=0]
----
