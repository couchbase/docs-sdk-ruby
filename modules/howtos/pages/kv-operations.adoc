...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=insert]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=replace]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=expiry-insert]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=durability,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=durability-observed,indent=0]
----
...
IMPORTANT: Preferred Server Group Replica Reads are only accessible with the {name-sdk} working with Couchbase Server 7.6.2 or newer (Capella or self-managed), from SDK version 3.5.5.
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=get-simple]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=get]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=remove]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=expiry-get]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=expiry-replace]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=expiry-touch]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_counter.rb[tag=increment]
----

[source,ruby]
----
include::devguide:example$ruby/kv_counter.rb[tag=incrementwithoptions]
----

.Decrement
[source,ruby]
----
include::devguide:example$ruby/kv_counter.rb[tag=decrement]
----

.Decrement (with options)
[source,ruby]
----
include::devguide:example$ruby/kv_counter.rb[tag=decrementwithoptions]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=range-scan-all-documents, indent=0]
----

<1> The `RangeScan` class has two optional attributes: `from` and `to`.
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=range-scan-prefix, indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=range-scan-sample, indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/kv_operations.rb[tag=range-scan-all-document-ids, indent=0]
----
...
See the xref:caching-example.adoc[Caching Example] for ideas on integrating with Rails.
