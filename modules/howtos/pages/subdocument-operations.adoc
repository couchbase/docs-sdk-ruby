...
(Sub-document {sqlpp} (formerly N1QL) queries are explained in the section xref:n1ql-queries-with-sdk.adoc[Querying with {sqlpp}].)
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=get]
----

.Check existence of sub-document path
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=exists]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=combine]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=upsert]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=insert]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=multi]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-append]
----

[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-prepend]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-create]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-upsert]
----


== Arrays as Unique Sets

Limited support also exists for treating arrays like unique sets, using the `.array_add_unique()` method.
This will do a check to determine if the given value exists or not before actually adding the item to the array:

[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-unique]
----

Note that currently the `.array_add_unique()` will fail with a _Path Mismatch_ error if the array contains JSON _floats_, _objects_, or _arrays_.
The `.array_add_unique()` operation will also fail with _Cannot Insert_ if the value to be added is one of those types as well.
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=array-insert]
----

// for your examples, above, CD: “I feel like somewhere in this we should also just add an example path like "my.path[1]" too, just to show how to use the index with a nested path. I don't think it's necessarily clear.”
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=counter-inc]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=counter-dec]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=create-path]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=lookupin-any-replica]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=lookupin-all-replicas]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=cas]
----
...
[source,ruby]
----
include::devguide:example$ruby/subdoc.rb[tag=durability]
----
