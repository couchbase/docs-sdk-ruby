...
[source,ruby]
----
include::example$subdoc.rb[tag=get]
----

.Check existence of sub-document path
[source,ruby]
----
include::example$subdoc.rb[tag=exists]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=combine]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=upsert]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=insert]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=multi]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=array-append]
----

[source,ruby]
----
include::example$subdoc.rb[tag=array-prepend]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=array-create]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=array-upsert]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=array-unique]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=array-insert]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=counter-inc]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=counter-dec]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=create-path]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=lookupin-any-replica]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=lookupin-all-replicas]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=cas]
----
...
[source,ruby]
----
include::example$subdoc.rb[tag=durability]
----
