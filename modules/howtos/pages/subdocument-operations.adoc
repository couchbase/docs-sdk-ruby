= Sub-Document Operations with the Ruby SDK
...
The _path_ follows N1QL syntax xref:#[below^], and xref:6.5@server:n1ql:n1ql-intro/queriesandresults.adoc[N1QL Queries and Results]).
