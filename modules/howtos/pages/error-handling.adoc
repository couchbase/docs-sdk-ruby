...
[abstract]
Errors, handling them from the Ruby SDK.
...
////
TODO for Sergey: provide an example for Ruby
[source,ruby]
----
include::example$error-handling.rb[tag=handle_retryable]
----
////

== KV

The KV Service exposes several common errors that can be encountered - both during development, and to be handled by the
production app. Here we will cover some of the most common errors.

=== Document does not exist

[source,ruby]
----
include::example$error-handling.ru[tag=DocumentNotFound]
----
...
[source,ruby]
----
include::example$error-handling.ru[tag=KeyExistsException]
----
...
[source,ruby]
----
include::example$error-handling.rb[tag=CasMismatch]
----
...
[source,ruby]
----
include::example$error-handling.rb[tag=DurabilityAmbiguous]
----
...
[source,ruby]
----
include::example$error-handling.rb[tag=DurabilityLevelNotAvailable]
----
