...
[source,ruby]
----
include::devguide:example$ruby/rails-caching-example/Gemfile[tag=add_dependency]
----
...
[source,ruby]
----
include::devguide:example$ruby/rails-caching-example/config/environments/development.rb[tag=cache_store_config]
----
...
[source,ruby]
----
include::devguide:example$ruby/rails-caching-example/app/controllers/wall_clock_controller.rb[tag=cache_time_for_3_seconds]
----
