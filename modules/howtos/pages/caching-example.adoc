...
You can also find the https://github.com/couchbase/docs-sdk-ruby/blob/release/3.5/modules/howtos/examples/rails-caching-example[full code for _this_ example here].
