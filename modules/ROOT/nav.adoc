...
.Getting Started!
* xref:hello-world:start-using-sdk.adoc[Start Using the Ruby SDK]
...
.References
* https://docs.couchbase.com/sdk-api/couchbase-ruby-client/files/couchbase.html[Ruby API Reference]
...
// ** xref:project-docs:migrating-sdk-code-to-3.n.adoc[Migrating to SDK 3 API] // not
