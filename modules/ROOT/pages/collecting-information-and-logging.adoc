= Collecting Information and Logging in the Ruby SDK with Couchbase Server
:navtitle: Collecting Information

[abstract]
//The Ruby SDK logs its own and libcouchbase events using the default logger implementation in PHP.
