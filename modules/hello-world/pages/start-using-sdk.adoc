...
The Ruby SDK supports https://www.ruby-lang.org/en/downloads/branches/[currently maintained Ruby versions], and recommends the latest stable version where possible (currently 4.0 as of March 2026).
...
Further details can be found in the xref:project-docs:sdk-release-notes.adoc#sdk-installation[full installation guide].
// end::install[]
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=imports,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/cloud.rb[tag=connect,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=connect,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=bucket,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=collection,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=upsert-get,indent=0]
----
...
[source,rb]
----
include::devguide:example$ruby/start_using.rb[tag=n1ql-query,indent=0]
----
...
[source,ruby]
----
include::devguide:example$ruby/start_using.rb[tag=disconnect,indent=0]
----
