...
Implement zone aware replica reads (https://github.com/couchbase/couchbase-ruby-client/pull/163[#163]).

* https://issues.couchbase.com/browse/RCBC-504[RCBC-504]:
Update core and version generation (https://github.com/couchbase/couchbase-ruby-client/pull/162[#162]).

* Updated core to 1.0.5.
Release notes: xref:cxx-sdk:project-docs:sdk-release-notes.adoc#version-1-0-5-24-january-2024[{cpp} SDK 1.0.5].
