...
* https://issues.couchbase.com/browse/RCBC-469[RCBC-469]:
  Support for Scoped Search Indexes. (https://github.com/couchbase/couchbase-ruby-client/pull/132[#132])
* https://issues.couchbase.com/browse/RCBC-467[RCBC-467]:
  Add support for Vector search. (https://github.com/couchbase/couchbase-ruby-client/pull/131[#131])
* https://issues.couchbase.com/browse/RCBC-468[RCBC-468]:
  Support for maxTTL value of -1 for collection 'no expiry' (https://github.com/couchbase/couchbase-ruby-client/pull/130[#130])
* https://issues.couchbase.com/browse/RCBC-410[RCBC-410], https://issues.couchbase.com/browse/RCBC-458[RCBC-458]:
  Add support for the `couchbase2` protocol (https://github.com/couchbase/couchbase-ruby-client/pull/126[#126], https://github.com/couchbase/couchbase-ruby-client/pull/127[#127])
* https://issues.couchbase.com/browse/RCBC-472[RCBC-472]:
  Ping management service when specified in options. (https://github.com/couchbase/couchbase-ruby-client/pull/134[#134])
* https://issues.couchbase.com/browse/RCBC-463[RCBC-463]:
  Add DocumentNotLocked error. (https://github.com/couchbase/couchbase-ruby-client/pull/128[#128])
...
* https://issues.couchbase.com/browse/RCBC-461[RCBC-461]:
  Call extract_expiry_time in to_backend of options instead of constructor (https://github.com/couchbase/couchbase-ruby-client/pull/124[#124])

==== Build and Test Improvements

* https://issues.couchbase.com/browse/RCBC-464[RCBC-464]:
  Improve stability of management tests. (https://github.com/couchbase/couchbase-ruby-client/pull/133[#133])
...
* https://issues.couchbase.com/browse/CXXCBC-462[CXXCBC-462]: Fix hanging when specifying a custom metadata collection via the public API & expose errors. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/532[#532])
...
* https://issues.couchbase.com/browse/CXXCBC-401[CXXCBC-401]: Add ping & diagnostics to public API. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/498[#498], https://github.com/couchbaselabs/couchbase-cxx-client/pull/503[#503])
...
* https://issues.couchbase.com/browse/CXXCBC-382[CXXCBC-382]: Fix `raw_binary_transcoder` so that `get`s on binary data are possible. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/459[#459])
* https://issues.couchbase.com/browse/CXXCBC-387[CXXCBC-387]: Cache formatted `mbcp_session` endpoints. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/462[#462], https://github.com/couchbaselabs/couchbase-cxx-client/pull/464[#464])
