...
=== Version 3.8.2 (2 September 2026)
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.8.2/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.8.1...3.8.2++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.8.2[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2.sha256.txt[couchbase-3.8.2.sha256.txt]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2.gem[couchbase-3.8.2.gem]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-opentelemetry-3.8.2.gem[couchbase-opentelemetry-3.8.2.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2-x86_64-linux.gem[couchbase-3.8.2-x86_64-linux.gem]
| Linux arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2-aarch64-linux.gem[couchbase-3.8.2-aarch64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2-x86_64-linux-musl.gem[couchbase-3.8.2-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2-x86_64-darwin.gem[couchbase-3.8.2-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.8.2/couchbase-3.8.2-arm64-darwin.gem[couchbase-3.8.2-arm64-darwin.gem]
|===

==== Fixes and Enhancements

* https://jira.issues.couchbase.com/browse/RCBC-557[RCBC-557]: Add parent_span to Ping options (#241).

* Update C++ core to 1.3.3 (#245, #244, #242). Includes bug fixes for https://jira.issues.couchbase.com/browse/CXXCBC-839[CXXCBC-839], https://jira.issues.couchbase.com/browse/CXXCBC-841[CXXCBC-841] and https://jira.issues.couchbase.com/browse/CXXCBC-864[CXXCBC-864].

=== Version 3.8.1 (2 July 2026)
...
Version 3.8.0 is a minor release of the third generation Ruby SDK, bringing a number of improvements.
Most notably the 4.6.0 release adds observability support (with the ability to integrate with `OpenTelemetry`, via the `couchbase-opentelemetry` extension),
and adds support for Ruby 4.0 --  see xref:compatibility.adoc#ruby-version-compatibility[Ruby Version Compatibility] for details of supported Ruby versions.
Support is also added for JWT authentication
and for credential rotation without downtime.

==== Ruby SDK

https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.8.0/index.html[API Reference] |
https://rubygems.org/gems/couchbase/versions/3.8.0[Rubygems]
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-opentelemetry-3.8.0/index.html[API Reference] |
https://rubygems.org/gems/couchbase-opentelemetry/versions/3.8.0[Rubygems]

===== Installing the OpenTelemetry Extension
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0.sha256.txt[couchbase-3.8.0.sha256.txt]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0.gem[couchbase-3.8.0.gem]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-opentelemetry-3.8.0.gem[couchbase-opentelemetry-3.8.0.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0-x86_64-linux.gem[couchbase-3.8.0-x86_64-linux.gem]
| Linux arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0-aarch64-linux.gem[couchbase-3.8.0-aarch64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0-x86_64-linux-musl.gem[couchbase-3.8.0-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0-x86_64-darwin.gem[couchbase-3.8.0-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.8.0/couchbase-3.8.0-arm64-darwin.gem[couchbase-3.8.0-arm64-darwin.gem]
|===


==== Fixes and Enhancements

* https://issues.couchbase.com/browse/RCBC-524[RCBC-524],
https://issues.couchbase.com/browse/RCBC-525[RCBC-525],
https://issues.couchbase.com/browse/RCBC-526[RCBC-526]:
OpenTelemetry integration
(https://github.com/couchbase/couchbase-ruby-client/pull/216[#216],
https://github.com/couchbase/couchbase-ruby-client/pull/195[#195],
https://github.com/couchbase/couchbase-ruby-client/pull/197[#197]).
+
Full support for distributed tracing and metrics using the `OpenTelemetry` API.
...
Enhanced observability by surfacing internal {cpp} core timing spans (e.g., encoding, dispatch, decoding) within the Ruby span hierarchy
(https://github.com/couchbase/couchbase-ruby-client/pull/210[#210]).

* https://issues.couchbase.com/browse/RCBC-536[RCBC-536]:
Added cluster name and cluster uuid span/metric attributes (https://github.com/couchbase/couchbase-ruby-client/pull/202[#202]).
Automatically attaches `db.couchbase.cluster_name` and `db.couchbase.cluster_uuid` to all telemetry signals.

* https://issues.couchbase.com/browse/RCBC-530[RCBC-530]:
Deprecated Support for MapReduce Views
(https://github.com/couchbase/couchbase-ruby-client/pull/194[#194]).
MapReduce View APIs are now marked as deprecated in alignment with the Couchbase Server deprecation schedule.

* https://issues.couchbase.com/browse/RCBC-525[RCBC-525]:
Fixed names of `lookup_in_all_replicas` and `lookup_in_any_replica` spans
(https://github.com/couchbase/couchbase-ruby-client/pull/220[#220]).

* https://issues.couchbase.com/browse/RCBC-534[RCBC-534]:
Correctly set tracer to external tracer if one is provided
(https://github.com/couchbase/couchbase-ruby-client/pull/199[#199]).

* Added support for Ruby 4.0
(https://github.com/couchbase/couchbase-ruby-client/pull/198[#198]).

* Added `inventory_with_opentelemetry` example for the `couchbase-opentelemetry` gem
(https://github.com/couchbase/couchbase-ruby-client/pull/222[#222]).

* Updated core to 1.3.1
(https://github.com/couchbase/couchbase-ruby-client/pull/221[#221],
https://github.com/couchbase/couchbase-ruby-client/pull/219[#219]).





== Ruby SDK 3.7 Releases


=== Version 3.7.0 (29 September 2025)
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.7.0/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.6.0...3.7.0++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.7.0[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0.sha256sum[couchbase-3.7.0.sha256sum]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0.gem[couchbase-3.7.0.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0-x86_64-linux.gem[couchbase-3.7.0-x86_64-linux.gem]
| Linux arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0-aarch64-linux.gem[couchbase-3.7.0-aarch64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0-x86_64-linux-musl.gem[couchbase-3.7.0-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0-x86_64-darwin.gem[couchbase-3.7.0-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.7.0/couchbase-3.7.0-arm64-darwin.gem[couchbase-3.7.0-arm64-darwin.gem]
|===

==== New Features


* https://jira.issues.couchbase.com/browse/RCBC-517[RCBC-517]:
Added support vector search prefilter (https://github.com/couchbase/couchbase-ruby-client/pull/180[#180]).
* https://jira.issues.couchbase.com/browse/RCBC-518[RCBC-518]:
Added way to disable enterprise analytics check programmatically (https://github.com/couchbase/couchbase-ruby-client/pull/186[#186]).
* Updated core to `1.2.0` (https://github.com/couchbase/couchbase-ruby-client/pull/188[#188], https://github.com/couchbase/couchbase-ruby-client/pull/181[#181]).

==== Build and Test Infrastructure Improvements

* Fixed `rubocop` error & warnings (https://github.com/couchbase/couchbase-ruby-client/pull/185[#185], https://github.com/couchbase/couchbase-ruby-client/pull/187[#187]).
* Fix `simplecov` error in test helper (https://github.com/couchbase/couchbase-ruby-client/pull/184[#184]).
* Github Actions:
** Pinned `clang` tools in linters workflow (https://github.com/couchbase/couchbase-ruby-client/pull/183[#183]);
** Updated Windows runners (https://github.com/couchbase/couchbase-ruby-client/pull/182[#182]).


== Ruby SDK 3.6 Releases

=== Version 3.6.0 (2 June 2025)
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.6.0/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.5.7...3.6.0++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.6.0[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0.sha256sum[couchbase-3.6.0.sha256sum]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0.gem[couchbase-3.6.0.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0-x86_64-linux.gem[couchbase-3.6.0-x86_64-linux.gem]
| Linux arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0-aarch64-linux.gem[couchbase-3.6.0-aarch64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0-x86_64-linux-musl.gem[couchbase-3.6.0-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0-x86_64-darwin.gem[couchbase-3.6.0-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.6.0/couchbase-3.6.0-arm64-darwin.gem[couchbase-3.6.0-arm64-darwin.gem]
|===

==== New Features

* https://issues.couchbase.com/browse/516[RCBC-516]:
Include `storage_backend` in `get_bucket/get_all_buckets` results (https://github.com/couchbase/couchbase-ruby-client/pull/173[#173]).

* https://issues.couchbase.com/browse/510[RCBC-510]:
Added `BucketSettings#num_vbuckets`  (https://github.com/couchbase/couchbase-ruby-client/pull/174[#174]).

==== Fixes

* https://issues.couchbase.com/browse/511[RCBC-511]:
Updated core to pick up improved user lock/unlock error messages & logs (https://github.com/couchbase/couchbase-ruby-client/pull/177[#177]).
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.5.7/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.5.6...3.5.7++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.5.7[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7.sha256sum[couchbase-3.5.7.sha256sum]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7.gem[couchbase-3.5.7.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7-x86_64-linux.gem[couchbase-3.5.7-x86_64-linux.gem]
| Linux arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7-aarch64-linux.gem[couchbase-3.5.7-aarch64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7-x86_64-linux-musl.gem[couchbase-3.5.7-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7-x86_64-darwin.gem[couchbase-3.5.7-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.5.7/couchbase-3.5.7-arm64-darwin.gem[couchbase-3.5.7-arm64-darwin.gem]
|===

==== Fixes

* https://issues.couchbase.com/browse/RCBC-514[RCBC-514]:
Added support for Ruby 3.4 and Linux/arm64 (https://github.com/couchbase/couchbase-ruby-client/pull/[#170]).

* https://issues.couchbase.com/browse/RCBC-515[RCBC-515]:
Enforce `CMAKE_POLICY_VERSION_MINIMUM` to be `3.5` for `snappy` and `cmake` `4.x` (https://github.com/couchbase/couchbase-ruby-client/pull/172[#172]).


=== Version 3.5.6 (18 March 2025)
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.5.6/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.5.5...3.5.6++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.5.6[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6.sha256sum[couchbase-3.5.6.sha256sum]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6.gem[couchbase-3.5.6.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6-x86_64-linux.gem[couchbase-3.5.6-x86_64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6-x86_64-linux-musl.gem[couchbase-3.5.6-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6-x86_64-darwin.gem[couchbase-3.5.6-x86_64-darwin.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.5.6/couchbase-3.5.6-arm64-darwin.gem[couchbase-3.5.6-arm64-darwin.gem]
|===

==== Fixes


* https://issues.couchbase.com/browse/RCBC-512[RCBC-512]:
Invoke fork hooks to protect SDK internal state (https://github.com/couchbase/couchbase-ruby-client/pull/156[#165]).

* Updated core to 1.0.6.
Release notes: xref:cxx-sdk:project-docs:sdk-release-notes.adoc#version-1-0-6-12-march-2025[{cpp} SDK 1.0.6].

=== Version 3.5.5 (28 January 2025)
...
https://docs.couchbase.com/sdk-api/couchbase-ruby-client-3.5.5/index.html[API Reference] |
link:++https://github.com/couchbase/couchbase-ruby-client/compare/3.5.4...3.5.5++[Full Changelog] |
https://rubygems.org/gems/couchbase/versions/3.5.5[Rubygems]
...
|===
| Platform            | File
| Checksums           | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5.sha256sum[couchbase-3.5.5.sha256sum]
| Source Archive      | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5.gem[couchbase-3.5.5.gem]
| Linux x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5-x86_64-linux.gem[couchbase-3.5.5-x86_64-linux.gem]
| Linux x86_64 (musl) | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5-x86_64-linux-musl.gem[couchbase-3.5.5-x86_64-linux-musl.gem]
| macOS x86_64        | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5-x86_64-darwin.gem[couchbase-3.5.5-x86_64-darwin-20.gem]
| macOS arm64         | https://packages.couchbase.com/clients/ruby/sdk-3.5.5/couchbase-3.5.5-arm64-darwin.gem[couchbase-3.5.5-arm64-darwin.gem]
|===

==== Fixes

* https://issues.couchbase.com/browse/RCBC-487[RCBC-487]:
...
and later opt-in for local operations during replica reads (https://github.com/couchbase/couchbase-ruby-client/pull/163[#163]).

* https://issues.couchbase.com/browse/RCBC-504[RCBC-504]:
Updated core and version generation (https://github.com/couchbase/couchbase-ruby-client/pull/162[#162]).
...
Release notes: xref:cxx-sdk:project-docs:sdk-release-notes.adoc#version-1-0-3-22-october-2024[{cpp} SDK 1.0.3].

* Added CI scripts for Rocky Linux
...
Release notes: xref:cxx-sdk:project-docs:sdk-release-notes.adoc#version-1-0-1-22-august-2024[{cpp} SDK 1.0.1].
...
Release notes:
https://docs.couchbase.com/cxx-sdk/current/project-docs/sdk-release-notes.html#version-1-0-0-26-june-2024[{cpp} SDK 1.0.0].
...
===== Changes in Couchbase {cpp} SDK 1.0.0-dp.14
...
===== Changes in Couchbase {cpp} SDK 1.0.0-dp.13
...
===== Changes in Couchbase {cpp} SDK 1.0.0-dp.12
...
===== Changes in Couchbase {cpp} SDK 1.0.0-dp.11
...
===== Changes in Couchbase {cpp} SDK 1.0.0-dp.10
...
* Fix the durability level always being set to `none` in the {cpp} core
...
==== Underlying {cpp} SDK Core

==== Notable Changes in {cpp} SDK 1.0.0-dp.4
...
==== Notable changes in {cpp} SDK 1.0.0-dp.3
...
==== Notable changes in {cpp} SDK 1.0.0-dp.2
...
==== Notable changes in {cpp} SDK 1.0.0-dp.1
...
==== Notable changes in {cpp} SDK 1.0.0-beta.3
