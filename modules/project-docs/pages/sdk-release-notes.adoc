...
Ruby SDK  supports MRI Ruby versions 2.5, 2.6 and 2.7. The source package is available through
https://rubygems.org/gems/couchbase and could be installed with
