...
* https://jira.issues.couchbase.com/browse/RCBC-517[RCBC-517]: Support vector search prefilter (https://github.com/couchbase/couchbase-ruby-client/pull/180[#180])

* https://jira.issues.couchbase.com/browse/RCBC-518[RCBC-518]: Add way to disable enterprise analytics check programmatically (https://github.com/couchbase/couchbase-ruby-client/pull/186[#186])

* Update core to 1.2.0 (https://github.com/couchbase/couchbase-ruby-client/pull/188[#188], https://github.com/couchbase/couchbase-ruby-client/pull/181[#181])

==== Build and Test Infrastructure Improvements

* Fix rubocop error & warnings (https://github.com/couchbase/couchbase-ruby-client/pull/185[#185], https://github.com/couchbase/couchbase-ruby-client/pull/187[#187])

* Test helper: Fix simplecov error (https://github.com/couchbase/couchbase-ruby-client/pull/184[#184])

* Github Actions: Pin clang tools in linters workflow (https://github.com/couchbase/couchbase-ruby-client/pull/183[#183])

* Github Actions: Update Windows runners (https://github.com/couchbase/couchbase-ruby-client/pull/182[#182])
