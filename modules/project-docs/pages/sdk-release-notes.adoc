...
This is the first GA release of 3.2 series.
...
* https://issues.couchbase.com/browse/RCBC-301[RCBC-301]:
  Implement metrics. This feature is enabled by default, could be disabled in connection string with
  `enable_metrics=false` or programmatically:
+
[source,ruby]
----
...
* https://issues.couchbase.com/browse/RCBC-234[RCBC-234]:
 Implement tracing. This feature is enabled by default, but could be disabled in connection string with
`enable_tracing=false` or programmatically:
+
[source,ruby]
----
options = Cluster::ClusterOptions.new
...
* https://issues.couchbase.com/browse/RCBC-318[RCBC-318]:
  Parse and use revEpoch field in configuration

* https://issues.couchbase.com/browse/RCBC-324[RCBC-324]:
  Map query error code 13014 to `AuthenticationFailure` exception.

* https://issues.couchbase.com/browse/RCBC-227[RCBC-227]:
  Manage remote links for analytics

* https://issues.couchbase.com/browse/RCBC-283[RCBC-283]:
  Add collections support for search queries

* https://issues.couchbase.com/browse/RCBC-311[RCBC-311]:
  Fix scope qualifer encoding for analtyics

Dropped support of Ruby 2.5 and many smaller fixes and improvements.
