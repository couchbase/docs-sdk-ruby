...
* https://issues.couchbase.com/browse/516[RCBC-516]: Include storage_backend in get_bucket/get_all_buckets results. (https://github.com/couchbase/couchbase-ruby-client/pull/173[#173])
* https://issues.couchbase.com/browse/510[RCBC-510]: Add `BucketSettings#num_vbuckets`.  (https://github.com/couchbase/couchbase-ruby-client/pull/174[#174])

==== Fixes

* https://issues.couchbase.com/browse/511[RCBC-511]: Update core to pick up improved user lock/unlock error messages & logs. (https://github.com/couchbase/couchbase-ruby-client/pull/177[#177])
