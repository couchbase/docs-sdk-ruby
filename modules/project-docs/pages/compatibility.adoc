...
The Couchbase Ruby SDK is compatible with Ruby 2.6, 2.7, and 3.0.
...
At time of release, the Couchbase 3.2 Ruby SDK is fully compatible with Couchbase Capella, our fully-hosted database-as-a-service.
